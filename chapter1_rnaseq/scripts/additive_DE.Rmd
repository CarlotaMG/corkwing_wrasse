...
- **Constitutive differences** are identified using the additive model (`~ origin + temperature`) by comparing origins (e.g., West vs South) while controlling for temperature. These represent **baseline expression differences** that are consistent across temperatures and may reflect fixed genetic divergence.
